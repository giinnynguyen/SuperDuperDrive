...
- Implement the `TODOs` within the `CarService.java` and `CarController.java`  files => DONE
- Add additional tests to the `CarControllerTest.java` file based on the `TODOs` => DONE
- Implement API documentation using Swagger => DONE
